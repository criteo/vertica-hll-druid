...
CREATE OR REPLACE ANALYTIC FUNCTION HllDruidWindowDistinctCount AS LANGUAGE 'C++' NAME 'HllDruidWindowDistinctCountFactory' LIBRARY libhlldruid;
...
GRANT EXECUTE ON ANALYTIC FUNCTION HllDruidWindowDistinctCount(VARBINARY) TO PUBLIC;
